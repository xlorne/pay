...
public class RefundReqData extends MapXml {
    ...
    public RefundReqData(String key,String appid, String mch_id,String sub_mch_id, String out_trade_no, String out_refund_no, int total_fee, int refund_fee, String op_user_id) {
        this.appid = appid;
        this.mch_id = mch_id;
