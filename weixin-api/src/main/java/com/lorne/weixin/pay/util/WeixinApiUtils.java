...
public class WeixinApiUtils {
    ...
    public static Map<String, Object> getOrderQuery(WxConfig config, String out_trade_no) {
        return WeixinUtils.payOrderquery(config, out_trade_no);
    }


    public static Map<String, Object> refundOrder(WxConfig config, String out_trade_no, String out_refund_no, int total_fee, int refund_fee) {
        return WeixinUtils.refund(config, out_trade_no, out_refund_no, total_fee, refund_fee);
    }


    public static Map<String, Object> refundQueryOrder(WxConfig config, String out_trade_no) {
    ...
    public static boolean hasOrder(WxConfig config, String out_trade_no) {
        Map<String, Object> map = getOrderQuery(config, out_trade_no);
        if (null != map) {
            String return_code =(String) map.get("return_code");
            String result_code = (String)map.get("result_code");
            if (return_code.equals("SUCCESS") && result_code.equals("SUCCESS")) {
